...
namespace Nop.Services.Z_HaragAdmin.Customers
{
   public class CustomerService:ICustomerService
        
    {
        ...
        #endregion
        #region Ctor
        public CustomerService(IRepository<Customer> customerService, Core.IWorkContext workContext, IHostingEnvironment env)
        {
        ...
        {
            var customers = _customerRepository.TableNoTracking.Include(m => m.CustomerRoles);
