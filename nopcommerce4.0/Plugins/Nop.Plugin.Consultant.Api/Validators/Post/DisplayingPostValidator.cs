...
{
    public class DisplayingPostValidator : BaseNopValidator<DisplayingPostModel>
    {
        public DisplayingPostValidator(ILocalizationService localizationService, IDbContext dbContext)
        {
