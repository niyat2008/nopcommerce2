...
{
    public partial class ConsultationsController : BasePublicController
    {
        #region Fields
        ...
        public virtual IActionResult Navbar(PagingParams pagingParams)
        {
            ...
            var outputModel = new CategoryWithSubCategoriesOutputModel
            {
                ...
                Links = GetLinks(model, "Consultant.Consultations.Navbar"),
        ...
        public virtual IActionResult GetCategories(PagingParams pagingParams)
        {
            ...
            {
                Paging = model.GetHeader(),
                Links = GetLinks(model, "Consultant.Consultations.GetCategories"),
            ...
            return PartialView("ListOfCategory", outputModel);
        }
        ...
        public virtual IActionResult GetAllClosedPosts(PagingParams pagingParams)
        {
            ...
            {
                Paging = model.GetHeader(),
                Links = GetLinks(model, "Consultant.Consultations.GetAllClosedPosts"),
            ...
            ViewBag.UserRole = "Vistor";
            return PartialView("Posts", outputModel);
        }
        ...
        public IActionResult GetAllClosedPostsByCategoryId(PagingParams pagingParams, int CategoryId)
        {
            ...
            {
                Paging = model.GetHeader(),
                Links = GetLinksForCatPosts(model, "Consultant.Consultations.GetAllClosedPostsByCategoryId", CategoryId),
                Items = model.List.Select(m => new PostModel()
                {
                    Id = m.Id,
                    Text = m.Text,
        ...
        public IActionResult GetPost(int PostId)
        {
            ...
            return PartialView("PostDetails", model);
        }
        ...
        public virtual IActionResult GetCustomerConsultations()
        {
            if (!_workContext.CurrentCustomer.IsRegistered())
                return Unauthorized();
            ...
            return PartialView("CustomerConsultations");
        }

        public virtual IActionResult GetConsultantConsultations()
        {
            if (!_workContext.CurrentCustomer.IsRegistered())
                return Unauthorized();
            ...
            return PartialView("ConsultantConsultations");
        }
        ...
        public IActionResult GetCustomerClosedPosts(PagingParams pagingParams)
        {
            ...
            {
                Paging = model.GetHeader(),
                Links = GetLinks(model, "Consultant.Consultations.GetCustomerClosedPosts"),
                Items = model.List.Select(m => new PostModel()
                {
                    Id = m.Id,
                    Text = m.Text,
        ...
        public IActionResult GetCustomerOpenPosts(PagingParams pagingParams)
        {
            ...
            {
                Paging = model.GetHeader(),
                Links = GetLinks(model, "Consultant.Consultations.GetCustomerOpenPosts"),
                Items = model.List.Select(m => new PostModel()
                {
                    Id = m.Id,
                    Text = m.Text,
        ...
        public virtual IActionResult GetConsultantNotAnsweredPosts(PagingParams pagingParams)
        {
            ...
            {
                Paging = model.GetHeader(),
                Links = GetLinks(model, "Consultant.Consultations.GetConsultantNotAnsweredPosts"),
                Items = model.List.Select(m => new PostModel()
                {
                    Id = m.Id,
                    Text = m.Text,
        ...
        public IActionResult GetConsultantReservedPosts(PagingParams pagingParams)
        {
            ...
            {
                Paging = model.GetHeader(),
                Links = GetLinks(model, "Consultant.Consultations.GetConsultantReservedPosts"),
                Items = model.List.Select(m => new PostModel()
                {
                    Id = m.Id,
                    Text = m.Text,
        ...
        public IActionResult GetConsultantOpenPosts(PagingParams pagingParams)
        {
            ...
            {
                Paging = model.GetHeader(),
                Links = GetLinks(model, "Consultant.Consultations.GetConsultantOpenPosts"),
                Items = model.List.Select(m => new PostModel()
                {
                    Id = m.Id,
                    Text = m.Text,
        ...
        public IActionResult GetConsultantClosedPosts(PagingParams pagingParams)
        {
            ...
            {
                Paging = model.GetHeader(),
                Links = GetLinks(model, "Consultant.Consultations.GetConsultantClosedPosts"),
                Items = model.List.Select(m => new PostModel()
                {
                    Id = m.Id,
                    Text = m.Text,
        ...
        public IActionResult GetCommentsByPostId(PagingParams pagingParams, int PostId)
        {
            ...
            {
                Paging = model.GetHeader(),
                Links = GetLinksForPostComments(model, "Consultant.Consultations.GetCommentsByPostId", PostId),
            ...
            if (isPostClosed)
            {
                return PartialView("CommentsOnClosedPost", outputModel);
            }
            else
            {
                return PartialView("CommentsOnOpenPost", outputModel);
            }
        }
        ...
        public IActionResult Search(string Term, PagingParams pagingParams)
        {
            ...
            {
                Paging = model.GetHeader(),
                Links = GetLinksForSearch(model, "Consultant.Consultations.Search", Term),
                Items = model.List.Select(m => new PostModel()
                {
                    Id = m.Id,
                    Text = m.Text,
        ...
        public virtual IActionResult ChangeCatAndSub(PagingParams pagingParams)
        {
            ...
            return PartialView("ChangeCatAndSub", outputModel);
        }
        ...
        public IActionResult GetSubCategoriesByCategoryId(PagingParams pagingParams, int categoryId)
        {
            ...
            return PartialView("ListOfSubCategories", outputModel);
        }
