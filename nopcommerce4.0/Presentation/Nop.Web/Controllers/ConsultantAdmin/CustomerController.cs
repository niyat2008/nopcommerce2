...
using Nop.Web.Models.ConsultantAdmin.Customers;
...
namespace Nop.Web.Controllers.ConsultantAdmin
{
    public class CustomerController : Controller
    {
        ...
        //Get Members Ajax
        [HttpPost]
        public ActionResult GetMembersAjax()
        {
            if (!_workContext.CurrentCustomer.IsRegistered())
                return Unauthorized();
        ...
        public ActionResult GetMemberDetails(int id)
        {
            ...
            var customer = new CustomersModel
            {
                ...
                LastIpAddress = customerInDb.LastIpAddress,
                LastActivityDateUtc = customerInDb.LastActivityDateUtc
            };
